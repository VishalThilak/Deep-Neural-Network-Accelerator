...
alias com {
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_irq_clock_crosser.sv"                                                 -l altera_common_sv_packages -work irq_synchronizer                            
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_conduit_bfm.sv"                                                       -l altera_common_sv_packages -work dnn_accel_system_inst_pll_locked_bfm        
