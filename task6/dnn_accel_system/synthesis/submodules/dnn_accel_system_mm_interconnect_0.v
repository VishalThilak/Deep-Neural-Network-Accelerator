...
module dnn_accel_system_mm_interconnect_0 (
	...
	wire          rsp_mux_src_valid;                                                                  // rsp_mux:src_valid -> dot_0_avalon_master_agent:rp_valid
	wire  [107:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> dot_0_avalon_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                  // dot_0_avalon_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [6:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> dot_0_avalon_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                          // rsp_mux:src_startofpacket -> dot_0_avalon_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                            // rsp_mux:src_endofpacket -> dot_0_avalon_master_agent:rp_endofpacket
	...
	wire          vga_avalon_0_avalon_slave_0_agent_rdata_fifo_src_valid;                             // vga_avalon_0_avalon_slave_0_agent:rdata_fifo_src_valid -> vga_avalon_0_avalon_slave_0_agent_rdata_fifo:in_valid
	wire   [33:0] vga_avalon_0_avalon_slave_0_agent_rdata_fifo_src_data;                              // vga_avalon_0_avalon_slave_0_agent:rdata_fifo_src_data -> vga_avalon_0_avalon_slave_0_agent_rdata_fifo:in_data
	wire          vga_avalon_0_avalon_slave_0_agent_rdata_fifo_src_ready;                             // vga_avalon_0_avalon_slave_0_agent_rdata_fifo:in_ready -> vga_avalon_0_avalon_slave_0_agent:rdata_fifo_src_ready
	...
	wire   [31:0] dot_0_slave_agent_m0_address;                                                       // dot_0_slave_agent:m0_address -> dot_0_slave_translator:uav_address
	...
	wire  [108:0] dot_0_slave_agent_rf_source_data;                                                   // dot_0_slave_agent:rf_source_data -> dot_0_slave_agent_rsp_fifo:in_data
	...
	wire  [108:0] dot_0_slave_agent_rsp_fifo_out_data;                                                // dot_0_slave_agent_rsp_fifo:out_data -> dot_0_slave_agent:rf_sink_data
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> dot_0_slave_agent:cp_valid
	wire  [107:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> dot_0_slave_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // dot_0_slave_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> dot_0_slave_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> dot_0_slave_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> dot_0_slave_agent:cp_endofpacket
	wire          dot_0_avalon_master_agent_cp_valid;                                                 // dot_0_avalon_master_agent:cp_valid -> router:sink_valid
	wire  [107:0] dot_0_avalon_master_agent_cp_data;                                                  // dot_0_avalon_master_agent:cp_data -> router:sink_data
	wire          dot_0_avalon_master_agent_cp_ready;                                                 // router:sink_ready -> dot_0_avalon_master_agent:cp_ready
	wire          dot_0_avalon_master_agent_cp_startofpacket;                                         // dot_0_avalon_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          dot_0_avalon_master_agent_cp_endofpacket;                                           // dot_0_avalon_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire          dot_0_slave_agent_rp_valid;                                                         // dot_0_slave_agent:rp_valid -> router_009:sink_valid
	wire  [107:0] dot_0_slave_agent_rp_data;                                                          // dot_0_slave_agent:rp_data -> router_009:sink_data
	wire          dot_0_slave_agent_rp_ready;                                                         // router_009:sink_ready -> dot_0_slave_agent:rp_ready
	wire          dot_0_slave_agent_rp_startofpacket;                                                 // dot_0_slave_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          dot_0_slave_agent_rp_endofpacket;                                                   // dot_0_slave_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire  [107:0] cmd_demux_001_src2_data;                                                            // cmd_demux_001:src2_data -> crosser:in_data
	wire          cmd_demux_001_src2_ready;                                                           // crosser:in_ready -> cmd_demux_001:src2_ready
	wire    [6:0] cmd_demux_001_src2_channel;                                                         // cmd_demux_001:src2_channel -> crosser:in_channel
	...
	wire  [107:0] crosser_001_out_data;                                                               // crosser_001:out_data -> rsp_mux_001:sink2_data
	wire          crosser_001_out_ready;                                                              // rsp_mux_001:sink2_ready -> crosser_001:out_ready
	wire    [6:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> rsp_mux_001:sink2_channel
	...
	wire          vga_avalon_0_avalon_slave_0_agent_rdata_fifo_out_valid;                             // vga_avalon_0_avalon_slave_0_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] vga_avalon_0_avalon_slave_0_agent_rdata_fifo_out_data;                              // vga_avalon_0_avalon_slave_0_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          vga_avalon_0_avalon_slave_0_agent_rdata_fifo_out_ready;                             // avalon_st_adapter_002:in_0_ready -> vga_avalon_0_avalon_slave_0_agent_rdata_fifo:out_ready
	...
	wire          dot_0_slave_agent_rdata_fifo_src_valid;                                             // dot_0_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] dot_0_slave_agent_rdata_fifo_src_data;                                              // dot_0_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          dot_0_slave_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_006:in_0_ready -> dot_0_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> dot_0_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> dot_0_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // dot_0_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> dot_0_slave_agent:rdata_fifo_sink_error
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) vga_avalon_0_avalon_slave_0_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                          //       clk.clk
		.reset             (vga_avalon_0_reset_reset_bridge_in_reset_reset),         // clk_reset.reset
		.in_data           (vga_avalon_0_avalon_slave_0_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (vga_avalon_0_avalon_slave_0_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (vga_avalon_0_avalon_slave_0_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (vga_avalon_0_avalon_slave_0_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (vga_avalon_0_avalon_slave_0_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (vga_avalon_0_avalon_slave_0_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                                  // (terminated)
		.csr_read          (1'b0),                                                   // (terminated)
		.csr_write         (1'b0),                                                   // (terminated)
		.csr_readdata      (),                                                       // (terminated)
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (vga_avalon_0_reset_reset_bridge_in_reset_reset), // out_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (vga_avalon_0_reset_reset_bridge_in_reset_reset), //  in_clk_reset.reset
	...
	dnn_accel_system_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_0_data      (vga_avalon_0_avalon_slave_0_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (vga_avalon_0_avalon_slave_0_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (vga_avalon_0_avalon_slave_0_agent_rdata_fifo_out_ready), //         .ready
	...
	dnn_accel_system_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (pll_0_outclk0_clk),                       // in_clk_0.clk
		.in_rst_0_reset (dot_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (dot_0_slave_agent_rdata_fifo_src_data),   //     in_0.data
		.in_0_valid     (dot_0_slave_agent_rdata_fifo_src_valid),  //         .valid
		.in_0_ready     (dot_0_slave_agent_rdata_fifo_src_ready),  //         .ready
