...
module dnn_accel_system_mm_interconnect_0 (
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> wordcopy_0_slave_agent:cp_valid
	wire  [107:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> wordcopy_0_slave_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // wordcopy_0_slave_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> wordcopy_0_slave_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> wordcopy_0_slave_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> wordcopy_0_slave_agent:cp_endofpacket
	...
	wire          wordcopy_0_slave_agent_rp_valid;                                                    // wordcopy_0_slave_agent:rp_valid -> router_009:sink_valid
	wire  [107:0] wordcopy_0_slave_agent_rp_data;                                                     // wordcopy_0_slave_agent:rp_data -> router_009:sink_data
	wire          wordcopy_0_slave_agent_rp_ready;                                                    // router_009:sink_ready -> wordcopy_0_slave_agent:rp_ready
	wire          wordcopy_0_slave_agent_rp_startofpacket;                                            // wordcopy_0_slave_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          wordcopy_0_slave_agent_rp_endofpacket;                                              // wordcopy_0_slave_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          wordcopy_0_slave_agent_rdata_fifo_src_valid;                                        // wordcopy_0_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] wordcopy_0_slave_agent_rdata_fifo_src_data;                                         // wordcopy_0_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          wordcopy_0_slave_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_006:in_0_ready -> wordcopy_0_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> wordcopy_0_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> wordcopy_0_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // wordcopy_0_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> wordcopy_0_slave_agent:rdata_fifo_sink_error
	...
	dnn_accel_system_mm_interconnect_0_cmd_mux_001 cmd_mux_006 (
		.clk                 (pll_0_outclk0_clk),                            //       clk.clk
		.reset               (wordcopy_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	dnn_accel_system_mm_interconnect_0_cmd_demux_002 rsp_demux (
		.clk                (pll_0_outclk0_clk),                            //       clk.clk
		.reset              (wordcopy_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	dnn_accel_system_mm_interconnect_0_cmd_demux_002 rsp_demux_003 (
		.clk                (pll_0_outclk0_clk),                              //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	dnn_accel_system_mm_interconnect_0_cmd_demux_002 rsp_demux_005 (
		.clk                (pll_0_outclk0_clk),                              //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
